...
@WebServlet("/exam11_5_controller")
public class exam11_5_controller extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			RequestDispatcher ds = req.getRequestDispatcher("chapter11/errorType_error.jsp");
			ds.forward(req, resp);
		}
	}
