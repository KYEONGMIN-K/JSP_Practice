...
@WebServlet("/exam11_3_controller")
public class exam11_3_controller extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			RequestDispatcher ds = req.getRequestDispatcher("chapter11/exam11_3_result.jsp");
			ds.forward(req, resp);
		}catch(Exception exc) {
			...
			RequestDispatcher ds = req.getRequestDispatcher("chapter11/exam11_3_error.jsp");
			ds.forward(req, resp);
		}
	}
