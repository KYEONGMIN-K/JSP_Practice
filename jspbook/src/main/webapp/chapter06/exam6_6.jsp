...
<body>
	<h3>회원 가입</h3>
	<form action="exam6_6_result.jsp" name="member" method="post">
		...
		<p>취미 : 독서 <input type="checkbox" name="hobby" value="read" checked> 
		         운동 <input type="checkbox" name="hobby" value="exer">
		         영화 <input type="checkbox" name="hobby" value="movie">
		<p><textarea name="comment" cols="30" rows="3" placeholder="가입 인사를 입력해주세요."></textarea>         
		<p><input type="submit" value="가입하기"> <input type="submit" value="다시쓰기">
